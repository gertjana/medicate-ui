module Models.Medicines exposing (Medicine, Medicines, medicineDecoder, medicineListDecoder, viewMedicineList, dummy, toString)
...
type alias Medicines = List Medicine
medicineListDecoder: Decoder Medicines
medicineListDecoder = Decode.list medicineDecoder

toString : Medicine -> String
toString medicine = medicine.name ++ " ()" ++ String.fromFloat medicine.dose ++ " " ++ medicine.unit ++ ")"
...
viewMedicineList medicines = table [ class "medicines table table-striped table-condensed table-hover table-bordered" ]
                    [
